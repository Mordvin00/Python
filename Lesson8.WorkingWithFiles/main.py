...
'''
Поискал на просторах интерната и собрал в кучу более-менее рабочую версию согласно нашему заданию,
...
сложно сразу смекнуть какую команду или функию применить,
но это дело наживное!
На начальном этапе тяжело морально, когда ничего не работает, а потом,
когда уже получаешь в консоли хоть что то - сразу легче, видно на каком этапе ошибка:)
'''